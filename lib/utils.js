...
export const FORM_CLASSES = {
  ...
  button_primary: `font-semibold hover:font-bold text-lg text-white  bg-primary-dark hover:bg-primary-light focus:bg-primary-light transition duration-300 ease hover:ease-out focus:border-white focus:border-2 outline-none rounded-md shadow-md shadow-gray-800 `,
};
