...
export const FORM_CLASSES = {
  ...
  button_secondary: `w-full font-semibold hover:font-bold text-lg text-white bg-secondary  hover:bg-secondary_button focus:bg-secondary_button transition duration-300 ease hover:ease-out p-2 mb-4 focus:border-white focus:border-2 outline-none rounded-md shadow-md shadow-gray-800 `,
  button_primary: `w-full font-semibold hover:font-bold text-lg text-white  bg-primary-dark hover:bg-primary-light focus:bg-primary-light transition duration-300 ease hover:ease-out p-2 mb-4 focus:border-white focus:border-2 outline-none rounded-md shadow-md shadow-gray-800 `,
};
